...
/**
 * Create an edition for an organization.
 */
class CreateEdition
{
    ...
    {
        $this->edition = Edition::query()->create([
    ...
    private function log(): void
    {
        LogUserAction::dispatch(
            ...
            user: $this->user,
            action: UserActionEnum::EditionCreation,
            description: sprintf('Created an edition called %s', $this->edition->title),
        )->onQueue('low');
    }
}
