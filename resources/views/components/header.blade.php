    ...
    @if (isset($organization))
      ...
      @if (isset($member))
        <div class="ml-4 flex items-center gap-2">
          <a href="{{ route('organization.patron.show', [$organization, 'P-1001']) }}" data-turbo="true" class="rounded-md border border-transparent px-2 py-1 font-medium hover:border-gray-200 hover:bg-gray-100 dark:hover:border-gray-700 dark:hover:bg-gray-800">{{ __('Patrons') }}</a>
