  ...
  <div>
    <div class="flex flex-col gap-y-2">
      <div class="flex flex-col items-center gap-x-4 sm:flex-row sm:gap-x-2">
        <a href="" class="group flex items-center gap-x-2 transition-transform ease-in-out" data-turbo="true">
    ...
    <div class="mt-6 sm:mt-0">
      <div class="mb-2 flex gap-x-4">
        <a href="" class="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100" data-turbo="true">Privacy</a>
        <a href="" class="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100" data-turbo="true">Terms</a>
      </div>
