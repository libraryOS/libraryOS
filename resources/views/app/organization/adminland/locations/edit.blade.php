  ...
  <div class="grid grow bg-gray-50 sm:grid-cols-[220px_1fr] dark:bg-gray-950">
    ...
    <section class="p-4 sm:p-8">
      <div class="mx-auto max-w-5xl space-y-6 sm:px-0">
        ...
        <form action="{{ route('organization.adminland.location.update', [$organization->slug, $location->id]) }}" method="post" class="space-y-8">
          @csrf
          @method('PUT')
          ...
          <div class="grid gap-6 sm:grid-cols-3">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 sm:col-span-2 dark:border-gray-700 dark:bg-gray-900">
              <div class="grid gap-4 sm:grid-cols-2">
                <x-input id="name" :label="__('Name')" type="text" name="name" required autofocus :error="$errors->get('name')" value="{{ old('name', $location->name) }}" />
                <x-input id="code" :label="__('Code')" type="text" name="code" :error="$errors->get('code')" value="{{ old('code', $location->code) }}" />
              </div>
              <div class="mt-4">
                <x-input id="description" :label="__('Description')" type="text" name="description" :error="$errors->get('description')" value="{{ old('description', $location->description) }}" />
              </div>
            </div>
          </div>
          ...
          <div class="grid gap-6 sm:grid-cols-3">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 sm:col-span-2 dark:border-gray-700 dark:bg-gray-900">
              <div class="space-y-4">
                <x-select id="branch_id" :label="__('Branch')" name="branch_id" :options="$branchOptions" :selected="old('branch_id', (string) $location->branch_id)" :error="$errors->get('branch_id')" />
                <x-select id="parent_id" :label="__('Parent location')" name="parent_id" :options="$parentLocationOptions" :selected="old('parent_id', $location->parent_id === null ? '' : (string) $location->parent_id)" :error="$errors->get('parent_id')" />
              </div>
            </div>
          </div>
              ...
              <div class="space-y-4">
                <div class="flex items-start gap-3">
                  <div class="flex h-6 items-center">
                    ...
                    <input id="is_active" name="is_active" type="checkbox" value="1" @checked(old('is_active', $location->is_active)) class="h-4 w-4 rounded border-gray-300 accent-emerald-600 dark:border-gray-600" />
                  </div>
                  <div class="text-sm">
                ...
                <div class="flex items-start gap-3">
                  <div class="flex h-6 items-center">
                    ...
                    <input id="is_public" name="is_public" type="checkbox" value="1" @checked(old('is_public', $location->is_public)) class="h-4 w-4 rounded border-gray-300 accent-emerald-600 dark:border-gray-600" />
                  </div>
                  <div class="text-sm">
                ...
                <div class="flex items-start gap-3">
                  <div class="flex h-6 items-center">
                    ...
                    <input id="supports_pickups" name="supports_pickups" type="checkbox" value="1" @checked(old('supports_pickups', $location->supports_pickups)) class="h-4 w-4 rounded border-gray-300 accent-emerald-600 dark:border-gray-600" />
                  </div>
                  <div class="text-sm">
                ...
                <div class="flex items-start gap-3">
                  <div class="flex h-6 items-center">
                    ...
                    <input id="supports_returns" name="supports_returns" type="checkbox" value="1" @checked(old('supports_returns', $location->supports_returns)) class="h-4 w-4 rounded border-gray-300 accent-emerald-600 dark:border-gray-600" />
                  </div>
                  <div class="text-sm">
